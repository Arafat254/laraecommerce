...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.cart')->with('mightAlsoLike',$mightAlsoLike);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($dublicates->isNotEmpty()) {
            return redirect()->route('cart.index')->with('success_message',' Item Is Already your Cart');
        }
    ...
    /**
     * switch item for shopping card save for later
     *
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
